...
import { Shield, ArrowRight, Mail, Lock, Github } from "lucide-react";
      ...
      <div className="w-full max-w-md relative z-10 space-y-8">
        ...
        <div className="text-center space-y-6">
          ...
          <div className="space-y-2">
            <h1 className="text-3xl font-bold text-slate-900 tracking-tight leading-none">Welcome back</h1>
            <p className="text-sm font-bold text-slate-500 tracking-tight">Sign in to continue your study journey</p>
          </div>
        </div>
